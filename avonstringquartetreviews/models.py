...
class Review(db.Model):
    ...
    review_email = db.Column(db.String(25), unique=False, nullable=False)
...
class Details(db.Model):
    ...
    event_name = db.Column(db.String(25), unique=False, nullable=False)
    event_first_name = db.Column(db.String(25), unique=False, nullable=False)
    event_last_name = db.Column(db.String(25), unique=False, nullable=False)
    event_email = db.Column(db.String(25), unique=False, nullable=False)
    event_date = db.Column(db.Date, nullable=False)
    event_venue = db.Column(db.String(25), unique=False)
    event_start = db.Column(db.String(25), unique=False)
    event_end = db.Column(db.String(25), unique=False)
    event_content = db.Column(db.Text, nullable=False)


    def __repr__(self): 
        # __repr__ to represent itself in the form of a string
        return f"#{0} - Event Name: {1} | Date: {2} | Start: {3} | End: {4}"
        .format(
